      ...
      <aside id="sidebar"
         ...
         <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-0.5" onclick="closeSidebarOnMobile()">
            ...
            <div class="pt-3 mt-3 border-t border-neutral-800">
               <p class="px-3 mb-1.5 text-[10px] font-semibold uppercase tracking-widest text-neutral-600">Admin</p>
               <a href="{{ route('admin.dashboard') }}"
                  class="flex items-center space-x-3 px-3 py-2 rounded text-sm transition
                     {{ request()->routeIs('admin.dashboard') ? 'bg-white text-black font-semibold' : 'text-neutral-400 hover:bg-neutral-900 hover:text-white' }}">
                  <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                     <path stroke-linecap="round" stroke-linejoin="round"
               ...
               <a href="{{ route('admin.users') }}"
                  class="flex items-center space-x-3 px-3 py-2 rounded text-sm transition
                     {{ request()->routeIs('admin.users') ? 'bg-white text-black font-semibold' : 'text-neutral-400 hover:bg-neutral-900 hover:text-white' }}">
                  <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                     <path stroke-linecap="round" stroke-linejoin="round"
               ...
               <a href="{{ route('admin.devices') }}"
                  class="flex items-center space-x-3 px-3 py-2 rounded text-sm transition
                     {{ request()->routeIs('admin.devices') ? 'bg-white text-black font-semibold' : 'text-neutral-400 hover:bg-neutral-900 hover:text-white' }}">
                  <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                     <path stroke-linecap="round" stroke-linejoin="round"
